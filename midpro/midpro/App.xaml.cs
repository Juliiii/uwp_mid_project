...
namespace midpro
{
    ...
    sealed partial class App : Application
    {
        ...
        public App()
        {
            ...
            ApplicationView.PreferredLaunchViewSize = new Size(400, 680);
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (e.PrelaunchActivated == false)
            {
                if (rootFrame.Content == null)
                {
                    ...
                    // 参数
                    string q = "%zhulifeng%";
                    using (var statement = App.conn.Prepare("SELECT username, avatar, nickname, anchor FROM user WHERE username LIKE ? OR avatar LIKE ? OR nickname LIKE ? OR anchor LIKE ?"))
                    {
                        statement.Bind(1, q);
                        statement.Bind(2, q);
                        statement.Bind(3, q);
        ...
        {     // Get a reference to the SQLite database    
            conn = new SQLiteConnection("users.db");
